...
namespace GerenciadorVendas.Migrations
{
    ...
    [Migration("20240909144946_Initial6")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GerenciadorVendas.Model.Parcela", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GerenciadorVendas.Model.PagamentoAPrazo", b =>
                {
            ...
            modelBuilder.Entity("GerenciadorVendas.Model.PagamentoAVista", b =>
                {
                    b.HasBaseType("GerenciadorVendas.Modelos.Pagamento");
            ...
            modelBuilder.Entity("GerenciadorVendas.Modelos.PedidoConcluido", b =>
                {
                    b.HasBaseType("GerenciadorVendas.Modelos.Pedido");

                    b.ToTable("PedidoConcluido", (string)null);
                });

            modelBuilder.Entity("GerenciadorVendas.Modelos.PedidoPendente", b =>
                {
                    b.HasBaseType("GerenciadorVendas.Modelos.Pedido");

                    b.ToTable("PedidoPendente", (string)null);
                });
            ...
            modelBuilder.Entity("GerenciadorVendas.Model.Parcela", b =>
                {
                    b.HasOne("GerenciadorVendas.Model.PagamentoAPrazo", "PagamentoPertencente")
                        .WithMany("Parcelas")
            ...
            modelBuilder.Entity("GerenciadorVendas.Modelos.PedidoConcluido", b =>
                {
                    b.HasOne("GerenciadorVendas.Modelos.Pedido", null)
                        .WithOne()
                        .HasForeignKey("GerenciadorVendas.Modelos.PedidoConcluido", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GerenciadorVendas.Modelos.PedidoPendente", b =>
                {
                    b.HasOne("GerenciadorVendas.Modelos.Pedido", null)
                        .WithOne()
                        .HasForeignKey("GerenciadorVendas.Modelos.PedidoPendente", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
